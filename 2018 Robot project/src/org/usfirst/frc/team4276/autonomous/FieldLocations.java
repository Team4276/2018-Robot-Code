...
public class FieldLocations {
	...
	public static final double[] SWITCH_PREP_LEFT_A = new double[] { 7.2, 18.2 };
	public static final double[] SWITCH_PREP_RIGHT_A = new double[] { 7.2, 8.8 };
	...
	public static final double[] leftScaleScoringZoneA = new double[] { 24, 21 };
	public static final double[] rightScaleScoringZoneA = new double[] { 24, 6 };
